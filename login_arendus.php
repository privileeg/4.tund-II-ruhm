...
<body>
	...
	<form method="POST">
		...
		<input name="signupEmail" placeholder="Email" type="text" value="<?=$signupEmail;?>"> <?=$signupEmailError;?>
		<br><br>
		
		<input name="signupEesnimi" placeholder="Eesnimi" type="text" value="<?=$signupEesnimi;?>"> <?=$signupEesnimiError;?>
		<br><br>
		
		<input name="signupPerekonnanimi" type="text" placeholder="Perekonnanimi" value="<?=$signupPerekonnanimi;?>"> <?=$signupPerekonnanimiError;?>
		<br><br>
